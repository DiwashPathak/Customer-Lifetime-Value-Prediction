...
```bash
zenml integration install mlflow -y
zenml experiment-tracker register mlflow_tracker_lifetime --flavor=mlflow
zenml model-deployer register mlflow --flavor=mlflow
zenml stack register mlflow_stack_lifetime -a default -o default -d mlflow -e mlflow_tracker_lifetime --set
```
